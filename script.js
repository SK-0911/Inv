    ...
    paginatedInvestments.forEach((investment, index) => {
      ...
      row.innerHTML = `
        ...
        <td class="action-btns">
          <button class="update-btn" onclick="updateInvestment(${startIndex + index})">Update</button>
          <button class="remove-btn" onclick="removeInvestment(${startIndex + index})">Remove</button>
        </td>
      `;
